          ...
          {post.frontmatter.thumbnail && (
            <div className="post-content-image">
              {post.frontmatter.thumbnail.extension === 'mp4'
                ? <div className="video-container" dangerouslySetInnerHTML={{ __html: `<video autoplay playsinline loop muted><source src=${post.frontmatter.thumbnail.publicURL} type="video/mp4" /></video>`, }}></div>
